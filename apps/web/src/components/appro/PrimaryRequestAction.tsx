...
const actionConfig: Record<RequestDecisionStatus, ActionConfig> = {
  BLOCKING: {
    ...
    labelAdmin: 'Débloquer / Créer BC',
    icon: Plus,
    href: (id) => `/dashboard/appro/bons/new?demandeId=${id}&urgent=true`,
    style: 'bg-rose-600 text-white border-rose-700 shadow-apple-hover',
    hoverStyle: 'hover:bg-rose-700',
  },
  URGENT: {
    labelAppro: 'Créer BC',
    labelAdmin: 'Valider priorité',
    icon: Plus,
    href: (id) => `/dashboard/appro/bons/new?demandeId=${id}`,
    style: 'bg-orange-500 text-white border-orange-600',
    hoverStyle: 'hover:bg-orange-600',
  },
  PENDING_INFO: {
    labelAppro: 'Compléter infos',
    labelAdmin: 'Demander correction',
    icon: AlertTriangle,
    href: (id) => `/dashboard/appro/demandes/${id}`,
